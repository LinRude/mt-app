...
export default {
  data() {
    ...
    console.log("111",validatePass)
    console.log("222",validatePass2)
    return {
      registerForm: {
        userName: "",
        password: "",
  ...
  methods: {
    ...
    input(){
        ...
        var regNum  = /(\d)+/g;
        var reg = /_/g;
        var strongth = this.registerForm.password.match(reg) && this.registerForm.password.match(regStr) && this.registerForm.password.match(reg);
